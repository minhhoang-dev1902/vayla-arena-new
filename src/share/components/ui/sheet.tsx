...
import { useViewArea } from "@/share/components/providers/view-area-provider"
...
function SheetContent({
  ...
  const viewAreaContainer = useViewArea()
  const isScopedToViewArea = Boolean(viewAreaContainer)
  const positionClass = isScopedToViewArea ? "absolute" : "fixed"

  return (
    <SheetPortal container={viewAreaContainer ?? undefined}>
      <SheetOverlay className={positionClass} />
